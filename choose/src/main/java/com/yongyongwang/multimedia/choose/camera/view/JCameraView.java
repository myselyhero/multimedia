...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.multimedia_switch_camera);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
        ...
        switch (type) {
            case TYPE_VIDEO:
                ...
                if (jCameraLisenter != null) {
                    jCameraLisenter.recordSuccess(videoUrl, firstFrame,d);
                }
                break;
            case TYPE_PICTURE:
                mPhoto.setVisibility(INVISIBLE);
    ...
    public void setLeftClickListener(View.OnClickListener clickListener) {
        if (mCaptureLayout != null)
            mCaptureLayout.setLeftClickListener(clickListener);
    }
    ...
    public void setRightClickListener(View.OnClickListener listener){
        if (mCaptureLayout != null)
            mCaptureLayout.setRightClickListener(listener);
    }
